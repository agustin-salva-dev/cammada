...
export default async function EventoDetallePage({
  ...
  return (
    <div className="min-h-dvh w-full overflow-x-hidden flex flex-col px-4 sm:px-6 md:px-8 lg:px-10.5 2xl:px-42 py-20 sm:py-24 xl:pt-32 xl:pb-20 gap-8 sm:gap-10">
      <Navbar />
