...
export default async function Eventos() {
  ...
  return (
    <div className="min-h-dvh w-full overflow-x-hidden flex flex-col items-center px-4 sm:px-6 md:px-8 py-20 sm:py-24 xl:pt-32 xl:pb-20 gap-8 sm:gap-10">
      <Navbar />
      ...
      <div className="flex flex-col items-center gap-2.5 sm:gap-3 text-center max-w-2xl px-2 animate-fade-in">
        ...
        <p className="text-muted-foreground text-[10px] sm:text-sm xl:text-base font-light max-w-lg">
          ...
          carteleras, combates, estadísticas y toda la información de cada noche
          de peleas.
        </p>
      </div>
